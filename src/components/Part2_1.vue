...
export default {
  ...
  setup(props) {
    ...
    const partImage = require('@/assets/Part2_1.png');
    ...
    const typicalError1 = require('@/assets/1.png');
    const typicalError2 = require('@/assets/2.png');
    const typicalError3 = require('@/assets/3.png');
    const typicalError4 = require('@/assets/4.png');
